            ...
            <header className='flex justify-between items-center px-14 border-b py-4 shadow-5xl'>
                <div className='flex space-x-4 items-centern w-full'>
                    ...
                    <ul className='flex space-x-4 text-black cursor-pointer z-50'>
                        ...
                        <li className='capitalize text-lg font-semibold px-2 inline-flex items-center relative' onClick={() => handleToggleDropdown("all-shop")}>shop all <span>
                        ...
                        <li className='capitalize text-lg font-semibold px-2 inline-flex items-center relative' onClick={() => handleToggleDropdown("pages")}>pages <span> <ChevronDown className={` ${openDropdown === 'pages' ? ' transition-transform rotate-180 duration-500' : ''}`} /></span>
                            {openDropdown === "pages" && <PagesDropdown />}
                        </li>
                        <li className='capitalize text-lg font-semibold px-2 inline-flex items-center  relative' onClick={() => handleToggleDropdown("blog")}>blog <span><ChevronDown className={` ${openDropdown === 'blog' ? ' transition-transform rotate-180 duration-500' : ''}`} /></span>
