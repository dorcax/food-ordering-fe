          ...
          <CarouselItem key={meal.id} className="basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4 relative ">
            ...
            <div className="p-1">
              ...
              <Card className="rounded-xl overflow-hidden shadow-md h-full p-0 ">
                <Reveal>
                  <CardContent className="p-0 flex flex-col w-full h-full group relative border ">
                    ...
                    <div className="bg-gray-100 w-full py-4 px-4 rounded-b-xl  ">
                      <Reveal> <h2 className="text-[26px] font-extrabold ">{meal?.title}</h2></Reveal>
                      <Reveal>   <p className="text-xl font-medium mb-4 my-2">${meal?.price.toFixed(2)}AUD</p></Reveal>
                      <Reveal> <Button className="w-full rounded-xl bg-[rgb(88,148,3)] py-[22px]  text-base" onClick={() => handleOpenDrawer(<CartDetails />)}>Add to Cart  <ShoppingBasket className="size-4" />
                      </Button></Reveal>
                    </div>
