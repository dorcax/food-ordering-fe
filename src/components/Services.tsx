...
const Services = () => {
  ...
  return (
    <div className='px-3 py-10 lg:pl-14 md:py-14'> <section className='flex flex-col md:flex-row gap-3 md:justify-between items-center '>
      <section className='max-w-5xl'>
        <h2 className='text-xl md:text-3xl lg:text-4xl font-bold text-[rgb(88,148,3)]'>We cook it for you .</h2>
       
        <h3 className="text-2xl sm:text-3xl md:text-5xl font-bold md:py-4 leading-[60px] mb-0 md:mb-3">
        ...
        <MapinLocationButton className='my-6' />
      </section>

      <section className='w-full md:flex-1 min-w-[40%]'>
        {/* Big image container */}
        <img
      ...
      <section className='flex flex-col lg:flex-row  lg:justify-between   gap-4  mt-10 '>
        <section className='w-full lg:max-w-2xl'>
          <h2 className='text-[rgb(88,148,3)] text-3xl lg:text-5xl font-bold '>Many Restaurants   <span className='text-black text-3xl font-semibold md:leading-10 whitespace-nowrap  md:block'>and offer in one place</span></h2>
          ...
          <MapinLocationButton className='my-2' />
        </section>
        <section className=''>
          <Carousel
            opts={{
          ...
          >
                    ...
                    <Card className='border border-[rgb(88,148,3)]'>
                      <CardContent className=" px-6 ">
                        ...
                        <div className=' mt-4 w-full'>
                          ...
                          <p className='text-lg py-2'>{services.description}</p>
            ...
            {isHovered && (<><CarouselPrevious className="absolute left-0 top-1/2 -translate-y-1/2 z-10" />
