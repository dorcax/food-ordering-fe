...
const Hero = () => {
    return (
        <section className='py-2'>
            <div className='flex items-center bg-[url(https://catering-workdo.myshopify.com/cdn/shop/files/banner-image.png?v=1685358091)] bg-top-right [180%_50%] bg-no-repeat bg-[length:88%_44%]  sm:bg-[length:100%_58%]  xl:bg-[length:100%_120%]'>
                <section className=' max-w-4xl px-3 py-10 xl:p-14 '>
                    <p className='bg-[hsl(85,96%,30%)]  w-[260px] rounded-full py-2.5 px-2 text-white  text-lg'> 🔥 Get 10% off  for first order</p>
                    <section className=' mt-2 md:mt-8 max-w-2xl'>
                        ...
                        <div className='flex  flex-wrap gap-2 items-center md:space-x-2 mt-2'>
                            <Button className='w-[250px] text-sm rounded-lg py-6  border border-black'> <MapPin className='size-4' /> Find near by resturants <MoveRight /></Button>
                    ...
                    <div className='flex gap-5 items-center  mt-8 md:mt-5 shrink-0'>
                        ...
                        <a href="">  <img src="/google-icon.png" alt="" className='object-cover  w-[120px]  ' /></a>
                        <a href="">  <img src="/apple-icon3.png" alt="" className='object-cover  w-[120px]' /> </a>
