            ...
            <div className='flex items-center bg-[url(https://catering-workdo.myshopify.com/cdn/shop/files/banner-image.png?v=1685358091)] bg-top-right [180%_50%] bg-no-repeat bg-[length:100%_120%]'>
                <section className='px-14 max-w-4xl py-14 '>
                    ...
                    <section className='mt-8'>
                        <h2 className='text-black font-bold text-[40px]'><span className='text-[4rem] capitalize  text-[rgb(88,148,3)] leading-16'>many <br /> resturants</span> <br />and offers in one place</h2>

                        <p className=' text-lg'>Indulge in a culinary journey with our exquisite catering services, where every bite is a celebration of flavors and artistry.Elevate your event with our impeccable catering, where passion for food meets seamless service, creating unforgettable moments.</p>
                        <div className='flex items-center space-x-4 mt-8'>
                            <Button className='w-[300px] py-6 text-base  '> <MapPin className='size-6' /> Find near by resturants <MoveRight /></Button>

                            <Button className='w-[300px] py-6 bg-white border border-black  text-gray-600 text-base hover:text-black hover:bg-[0px]'> <Star className='size-6' /> Select your food preferencies</Button>
                        </div>
                    </section>
                    {/* google play store */}
                    <div className='flex gap-5 items-center mt-8'>
                        ...
                        <p className='text-[rgb(88,148,3)] text-lg'>Resturants and bars <br /> nearby you</p>
                    </div>
